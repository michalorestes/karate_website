...
<div id="centerContainer">
	<div id="headerContainer">
		<a href='www.karateagekan.22web.net'><img src="<?php bloginfo('template_directory'); ?>/images/logo.png" alt="logo" width="134" height="57" class="fl" /></a>
	...
	<div id="menuContainer">
			<div>
				<ul id="nav">
					...
					<li><a href="?page_id=14">Our Students <span>who learn with us</span></a></li>
